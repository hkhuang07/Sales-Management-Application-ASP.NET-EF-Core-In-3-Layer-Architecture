...
namespace ElectronicsStore.Presentation
{
    public partial class frmManufacturers : Form
    {
        ...
        {
            InitializeComponent();
            _service = new ManufacturerService(MapperConfig.Initialize()); // AutoMapper cấu hình
            ...
            btnFind.Click += (s, e) =>
            {
                ...
                else
                {
                    var filtered = _service.GetAll()
                        .Where(manu =>
                               manu.ManufacturerName.ToLower().Contains(keyword) ||
                               manu.ManufacturerAddress.ToLower().Contains(keyword) ||
                               manu.ManufacturerEmail.ToLower().Contains(keyword) ||
                               manu.ManufacturerPhone.ToLower().Contains(keyword)  // Thay đổi ở đây
                               )
                        .ToList();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                var dto = new ManufacturerDTO
                {
                    ...
                    ManufacturerAddress = txtManufacturerAddress.Text,
                    ManufacturerPhone = txtManufacturerPhone.Text,
                    ManufacturerEmail = txtManufacturerEmail.Text
                };
                        ...
                        foreach (DataRow r in table.Rows)
                        {
                            try
                            {
                                var dto = new ManufacturerDTO
                                {
                                    ...
                                    ManufacturerAddress = r["ManufacturerAddress"].ToString(),
                                    ManufacturerPhone = r["ManufacturerPhone"].ToString(),
                                    ManufacturerEmail = r["ManufacturerEmail"].ToString()
                                };
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    var manufacturer = _service.GetAll();
                    if (manufacturer != null)
                    {
                        foreach (var p in manufacturer)
                            table.Rows.Add(p.ID, p.ManufacturerName, p.ManufacturerEmail, p.ManufacturerPhone, p.ManufacturerAddress);
                    }
