...
1.2.1. .NET
1.2.1.1. Introduction to the .NET platform
...
1.2.2.1. Introducing Entity Framework Core
...
1.2.2.2. Advantages of EF Core in 3-Layer Development
...
2.1.1. General description of Use Case diagram
...
2.2. CLASS DIAGRAM
2.2.1. Object-Oriented Class Design
...
2.2.2. Relationships between classes
...
2.3.1. Description of the ER (Entity Relationship) diagram
...
2.3.2. Relationship design rules
...
3.2.2. Entity Model in Entity Framework Core
3.2.2.1. Context
...
3.3.2. Product management processing flow
...
3.3. Order processing flow (Create invoice)
Order process:
...
3.3.4. Invoice statistics processing flow
...
3.3.5. Customer management processing flow
...
3.3.6. Employee management processing flow
...
4.1.1. Understand the architecture and development process of management software
...
4.1.2. Complete construction of electronic sales management software
...
4.1.3. Improve professional skills and practical work
...
4.2.1. Developing Web or Mobile components
...
4.2.2. Expanding advanced functions
